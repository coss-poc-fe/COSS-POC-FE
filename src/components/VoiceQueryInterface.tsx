  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      type: "ai",
      content:
        "Hello! I'm your AI assistant. Ask me anything and I'll provide both text and audio responses.",
      timestamp: new Date(),
    },
  ]);
  ...
  const handleProcessTextQuery = async () => {
    ...
    try {
      const response = await fetch(
        "https://coss-poc-be.vercel.app/process-text-query",
        {
          method: "POST",
          headers: {
          ...
          <div className="text-center">
            ...
            <div
              className={`text-sm font-medium mt-2 ${
                isTotal ? "text-blue-100" : "text-gray-700"
              }`}
            >
              {displayLabel}
            </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-blue-100">
              Powered by multilingual AI pipeline
            </p>
          </div>
